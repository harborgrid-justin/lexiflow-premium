import { CaseStatus, CaseType } from "@cases/entities/case.entity";
...
export class CreateCaseDto {
  ...
  @ApiPropertyOptional({
    description:
      "Cause of action (e.g., 28:0158 Bankruptcy Appeal from Judgment/Order)",
  ...
  @ApiPropertyOptional({
    description: "Name of the originating court",
    example: "U.S. District Court for the Eastern District of Virginia",
    maxLength: 255,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: "Case number in the originating court",
    example: "1:24-cv-01442-LMB-IDD",
    maxLength: 100,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: "Name of the originating judge",
    example: "Hon. Leonie M. Brinkema",
    maxLength: 100,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: "Date filed in the originating court",
  ...
  @ApiPropertyOptional({
    description:
      "Detailed info about originating cases (multiple courts, dates, judges)",
    example: { origCourt: [{ district: "0422", caseNumber: "..." }] },
  })
  @IsOptional()
