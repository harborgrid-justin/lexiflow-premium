...
export class NotificationTemplatesService {
  ...
  constructor() {
    ...
    this.logger.log('NotificationTemplatesService initialized with default templates');
  }
  ...
  private initializeDefaultTemplates(): void {
    const defaultTemplates: NotificationTemplate[] = [
      ...
      },
      {
        ...
        priority: 'medium',
        icon: 'Upload',
        variables: [TemplateVariable.DOCUMENT_NAME, TemplateVariable.SENDER_NAME],
      },
      ...
      // Deadline Reminder Templates
      {
        ...
        variables: [TemplateVariable.ENTITY_NAME, TemplateVariable.DEADLINE_DATE],
      },
      {
   ...
   */
  getTemplate(type: string, channel: TemplateChannel): NotificationTemplate | null {
  ...
  render(
    ...
    if (!template) {
      this.logger.error(`Cannot render: template not found for ${type}/${channel}`);
      return null;
    }
    ...
    try {
      ...
      this.logger.error(`Error rendering template ${type}/${channel}: ${message}`);
      return null;
    }
  }
