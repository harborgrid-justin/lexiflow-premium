...
export class CreatePleadingTemplates1734456000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.createTable(
      new Table({
        name: 'pleading_templates',
        columns: [
          {
            name: 'id',
            type: 'uuid',
      ...
      VALUES 
        ...
        (
          ...
          '[
            ...
            {"type": "Paragraph", "content": "Defendant [DEFENDANT_NAME] answers Plaintiff''s Complaint as follows:", "order": 2},
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropTable('pleading_templates');
  }
}
