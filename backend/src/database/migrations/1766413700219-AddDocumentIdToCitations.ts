...
export class AddDocumentIdToCitations1766413700219 implements MigrationInterface {
    name = 'AddDocumentIdToCitations1766413700219'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "billed_by"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "billed_at"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "approved_by"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "approved_at"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "task_code"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "phase_code"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "internal_notes"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "discounted_total"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "ledes_code"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "expense_category"`);
        ...
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" DROP COLUMN "updated_at"`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" DROP COLUMN "jurisdiction_id"`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" DROP COLUMN "is_active"`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" DROP COLUMN "full_text"`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" DROP COLUMN "effective_date"`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" DROP COLUMN "created_at"`);
        await queryRunner.query(`ALTER TABLE "jurisdictions" DROP COLUMN "rules_url"`);
        await queryRunner.query(`ALTER TABLE "jurisdictions" DROP COLUMN "created_at"`);
        await queryRunner.query(`ALTER TABLE "jurisdictions" DROP COLUMN "updated_at"`);
        ...
        await queryRunner.query(`ALTER TABLE "etl_pipelines" DROP COLUMN "runs_successful"`);
        await queryRunner.query(`ALTER TABLE "etl_pipelines" DROP COLUMN "created_by"`);
        await queryRunner.query(`ALTER TABLE "etl_pipelines" DROP COLUMN "created_at"`);
        await queryRunner.query(`ALTER TABLE "etl_pipelines" DROP COLUMN "runs_total"`);
        await queryRunner.query(`ALTER TABLE "etl_pipelines" DROP COLUMN "runs_failed"`);
        await queryRunner.query(`ALTER TABLE "etl_pipelines" DROP COLUMN "last_run_at"`);
        await queryRunner.query(`ALTER TABLE "etl_pipelines" DROP COLUMN "updated_at"`);
        ...
        await queryRunner.query(`ALTER TABLE "citations" DROP COLUMN "document_id"`);
        await queryRunner.query(`ALTER TABLE "citations" DROP COLUMN "updated_at"`);
        await queryRunner.query(`ALTER TABLE "citations" DROP COLUMN "created_at"`);
        await queryRunner.query(`ALTER TABLE "citations" DROP COLUMN "case_id"`);
        ...
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "legal_hold_date"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "is_on_legal_hold"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "case_id"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "assigned_to"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "full_name"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "deleted_at"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "created_at"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "created_by"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "legal_hold_id"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "date_notified"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "data_sources"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "updated_by"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "data_collection_date"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "date_identified"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "legal_hold_released_date"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "first_name"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "last_name"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "updated_at"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "acknowledged_at"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "date_interviewed"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "is_key_player"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "is_recorded"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "created_by"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "scheduled_date"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "deleted_at"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "created_at"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "follow_up_actions"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "recording_path"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "case_id"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "conducted_by"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "data_sources_discussed"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "duration_minutes"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "custodian_name"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "updated_at"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "transcript_path"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "key_findings"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "actual_start_time"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "is_transcribed"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "custodian_id"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "actual_end_time"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "documents_identified"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "updated_by"`);
        ...
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "internalNotes" text`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "taskCode" character varying(255)`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "discountedTotal" numeric(10,2)`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "approvedBy" uuid`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "approvedAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "billedBy" uuid`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "billedAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "phaseCode" character varying(50)`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "expenseCategory" character varying(50)`);
        ...
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" ADD "fullText" text`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" ADD "effectiveDate" date`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" ADD "isActive" boolean NOT NULL DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "jurisdictions" ADD "rulesUrl" character varying(500)`);
        await queryRunner.query(`ALTER TABLE "jurisdictions" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "jurisdictions" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "etl_pipelines" ADD "createdBy" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "etl_pipelines" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "etl_pipelines" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "citations" ADD "documentId" character varying`);
        await queryRunner.query(`ALTER TABLE "citations" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "citations" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "custodians" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "deletedAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "caseId" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "custodianId" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "custodianName" character varying(300) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "scheduledDate" TIMESTAMP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "actualStartTime" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "actualEndTime" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "durationMinutes" integer`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "keyFindings" text`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "dataSourcesDiscussed" jsonb`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "documentsIdentified" jsonb`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "followUpActions" jsonb`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "isRecorded" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "recordingPath" character varying(500)`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "isTranscribed" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "transcriptPath" character varying(500)`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "conductedBy" uuid`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "createdBy" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "updatedBy" uuid`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "deletedAt" TIMESTAMP`);
        ...
        await queryRunner.query(`ALTER TABLE "advisors" DROP COLUMN "case_id"`);
        await queryRunner.query(`ALTER TABLE "advisors" ADD "case_id" uuid`);
        await queryRunner.query(`ALTER TABLE "experts" DROP COLUMN "case_id"`);
        await queryRunner.query(`ALTER TABLE "experts" ADD "case_id" uuid`);
        await queryRunner.query(`ALTER TABLE "case_strategies" DROP COLUMN "case_id"`);
        await queryRunner.query(`ALTER TABLE "case_strategies" ADD "case_id" uuid`);
        ...
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" ALTER COLUMN "jurisdictionId" SET NOT NULL`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_8776158e9ef020ce7b066dd20e" ON "time_entries" ("invoice_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "advisors" ADD CONSTRAINT "FK_1cc457eea1fe8616e0c47fddd5b" FOREIGN KEY ("case_id") REFERENCES "cases"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "experts" ADD CONSTRAINT "FK_9d5a00f3922679c8df1541fd64b" FOREIGN KEY ("case_id") REFERENCES "cases"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "case_strategies" ADD CONSTRAINT "FK_3c656d072a237b834d61131e0d8" FOREIGN KEY ("case_id") REFERENCES "cases"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "trial_events" DROP CONSTRAINT "FK_bc7d5ddd431b24e6c54a539dee7"`);
        await queryRunner.query(`ALTER TABLE "witness_prep_sessions" DROP CONSTRAINT "FK_3a7d9cd0d420e11136a50e25f93"`);
        await queryRunner.query(`ALTER TABLE "case_strategies" DROP CONSTRAINT "FK_3c656d072a237b834d61131e0d8"`);
        await queryRunner.query(`ALTER TABLE "experts" DROP CONSTRAINT "FK_9d5a00f3922679c8df1541fd64b"`);
        await queryRunner.query(`ALTER TABLE "advisors" DROP CONSTRAINT "FK_1cc457eea1fe8616e0c47fddd5b"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_8776158e9ef020ce7b066dd20e"`);
        ...
        await queryRunner.query(`ALTER TABLE "time_off_requests" ADD CONSTRAINT "FK_0cf85f4d0030faff30be5cdd734" FOREIGN KEY ("employeeId") REFERENCES "employees"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" ALTER COLUMN "jurisdictionId" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" ADD CONSTRAINT "FK_bf536c4779c32c8906c523c8fc6" FOREIGN KEY ("jurisdictionId") REFERENCES "jurisdictions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "witness_prep_sessions" ADD CONSTRAINT "FK_3a7d9cd0d420e11136a50e25f93" FOREIGN KEY ("caseId") REFERENCES "cases"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "case_strategies" DROP COLUMN "case_id"`);
        await queryRunner.query(`ALTER TABLE "case_strategies" ADD "case_id" character varying`);
        await queryRunner.query(`ALTER TABLE "experts" DROP COLUMN "case_id"`);
        await queryRunner.query(`ALTER TABLE "experts" ADD "case_id" character varying`);
        await queryRunner.query(`ALTER TABLE "advisors" DROP COLUMN "case_id"`);
        await queryRunner.query(`ALTER TABLE "advisors" ADD "case_id" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "deletedAt"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "updatedBy"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "createdBy"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "conductedBy"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "transcriptPath"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "isTranscribed"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "recordingPath"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "isRecorded"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "followUpActions"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "documentsIdentified"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "dataSourcesDiscussed"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "keyFindings"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "durationMinutes"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "actualEndTime"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "actualStartTime"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "scheduledDate"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "custodianName"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "custodianId"`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" DROP COLUMN "caseId"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "deletedAt"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "custodians" DROP COLUMN "createdAt"`);
        ...
        await queryRunner.query(`ALTER TABLE "citations" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "citations" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "citations" DROP COLUMN "documentId"`);
        ...
        await queryRunner.query(`ALTER TABLE "etl_pipelines" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "etl_pipelines" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "etl_pipelines" DROP COLUMN "createdBy"`);
        ...
        await queryRunner.query(`ALTER TABLE "jurisdictions" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "jurisdictions" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "jurisdictions" DROP COLUMN "rulesUrl"`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" DROP COLUMN "isActive"`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" DROP COLUMN "effectiveDate"`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" DROP COLUMN "fullText"`);
        ...
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "expenseCategory"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "phaseCode"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "billedAt"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "billedBy"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "approvedAt"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "approvedBy"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "discountedTotal"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "taskCode"`);
        await queryRunner.query(`ALTER TABLE "time_entries" DROP COLUMN "internalNotes"`);
        ...
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "updated_by" uuid`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "documents_identified" jsonb`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "actual_end_time" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "custodian_id" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "is_transcribed" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "actual_start_time" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "key_findings" text`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "transcript_path" character varying(500)`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "custodian_name" character varying(300) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "duration_minutes" integer`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "data_sources_discussed" jsonb`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "conducted_by" uuid`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "case_id" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "recording_path" character varying(500)`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "follow_up_actions" jsonb`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "deleted_at" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "scheduled_date" TIMESTAMP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "created_by" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "custodian_interviews" ADD "is_recorded" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "is_key_player" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "date_interviewed" date`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "acknowledged_at" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "last_name" character varying(200) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "first_name" character varying(200) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "legal_hold_released_date" date`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "date_identified" date`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "data_collection_date" date`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "updated_by" uuid`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "data_sources" jsonb`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "date_notified" date`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "legal_hold_id" uuid`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "created_by" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "deleted_at" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "full_name" character varying(400) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "assigned_to" uuid`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "case_id" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "is_on_legal_hold" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "custodians" ADD "legal_hold_date" date`);
        ...
        await queryRunner.query(`ALTER TABLE "citations" ADD "case_id" character varying`);
        await queryRunner.query(`ALTER TABLE "citations" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "citations" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "citations" ADD "document_id" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "etl_pipelines" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "etl_pipelines" ADD "last_run_at" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "etl_pipelines" ADD "runs_failed" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "etl_pipelines" ADD "runs_total" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "etl_pipelines" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "etl_pipelines" ADD "created_by" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "etl_pipelines" ADD "runs_successful" integer NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE "jurisdictions" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "jurisdictions" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "jurisdictions" ADD "rules_url" character varying(500)`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" ADD "effective_date" date`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" ADD "full_text" text`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" ADD "is_active" boolean NOT NULL DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" ADD "jurisdiction_id" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "jurisdiction_rules" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "expense_category" character varying(50)`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "ledes_code" character varying(20)`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "discounted_total" numeric(10,2)`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "internal_notes" text`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "phase_code" character varying(50)`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "task_code" character varying(255)`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "approved_at" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "approved_by" uuid`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "billed_at" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "time_entries" ADD "billed_by" uuid`);
        await queryRunner.query(`ALTER TABLE "case_strategies" ADD "caseId" uuid`);
