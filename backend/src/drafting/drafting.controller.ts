...
export class DraftingController {
  ...
  async getTemplates(
    ...
    if (category || jurisdiction || practiceArea || search) {
      return this.draftingService.getAllTemplates(category, jurisdiction, practiceArea, search);
    }
  ...
  async createTemplate(@Body() dto: CreateTemplateDto, @Request() req: RequestWithUser) {
    const userId = req.user?.id || '00000000-0000-0000-0000-000000000001';
  ...
  async archiveTemplate(@Param('id', ParseUUIDPipe) id: string, @Request() req: RequestWithUser) {
    const userId = req.user?.id || '00000000-0000-0000-0000-000000000001';
  ...
  async duplicateTemplate(@Param('id', ParseUUIDPipe) id: string, @Request() req: RequestWithUser) {
    const userId = req.user?.id || '00000000-0000-0000-0000-000000000001';
  ...
  async generateDocument(@Body() dto: GenerateDocumentDto, @Request() req: RequestWithUser) {
    const userId = req.user?.id || '00000000-0000-0000-0000-000000000001';
  ...
  async getAllGeneratedDocuments(
    ...
    const userId = req.user?.id || '00000000-0000-0000-0000-000000000001';
    return this.draftingService.getAllGeneratedDocuments(userId, status as any, caseId);
  }
  ...
  async submitForReview(@Param('id', ParseUUIDPipe) id: string, @Request() req: RequestWithUser) {
    const userId = req.user?.id || '00000000-0000-0000-0000-000000000001';
  ...
  async finalizeDocument(@Param('id', ParseUUIDPipe) id: string, @Request() req: RequestWithUser) {
    const userId = req.user?.id || '00000000-0000-0000-0000-000000000001';
