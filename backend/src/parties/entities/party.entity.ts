...
import { Counsel } from "@parties/entities/counsel.entity";
import {
  Column,
  Entity,
  Index,
...
export class Party extends BaseEntity {
  ...
  @ManyToMany(() => Counsel, (counsel) => counsel.parties)
  @JoinTable({
    name: "party_counsels",
    joinColumn: { name: "party_id", referencedColumnName: "id" },
    inverseJoinColumn: { name: "counsel_id", referencedColumnName: "id" },
  })
  counsels?: Counsel[];
}
