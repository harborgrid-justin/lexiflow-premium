...
import { X, Lock, FileText, MessageSquare, UploadCloud, Bell } from 'lucide-react';
                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden flex flex-col h-full">
                    ...
                    <div className="p-5 space-y-4 flex-1">
                        ...
                        <div className="my-4 flex items-center gap-4">
                            ...
                            <span className="text-[10px] text-slate-400 uppercase font-bold">System Notification</span>
                            <div className="h-px bg-slate-200 flex-1"></div>
                        </div>

                        <div className="text-xs text-center text-slate-500 bg-slate-50 py-2 rounded">
                            Invoice #4022 marked as Paid via Wire Transfer.
                        </div>
                    </div>
