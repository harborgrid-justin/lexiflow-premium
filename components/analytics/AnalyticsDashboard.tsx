...
const JudgeAnalytics = React.lazy(() => import('./JudgeAnalytics').then(m => ({ default: m.JudgeAnalytics })));
const CounselAnalytics = React.lazy(() => import('./CounselAnalytics').then(m => ({ default: m.CounselAnalytics })));
const CasePrediction = React.lazy(() => import('./CasePrediction').then(m => ({ default: m.CasePrediction })));
