        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
            <div>
                <div className="flex items-start justify-between mb-2">
                    <div className={cn("text-xs font-mono px-2 py-1 rounded border font-bold", theme.surfaceHighlight, theme.border.default, theme.text.secondary)}>
                        {citation.citation}
                    </div>
            ...
            <div className="space-y-3">
                <h4 className={cn("text-xs font-bold uppercase border-b pb-2", theme.text.tertiary, theme.border.light)}>Referencing Cases</h4>
                {isLoading ? (
            ...
            <div className="space-y-3">
                <div className={cn("flex justify-between items-center border-b pb-2", theme.border.light)}>
