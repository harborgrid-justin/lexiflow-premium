        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
            <div>
                ...
                <div className="space-y-2">
                    <label className={cn("flex items-center p-2 border rounded cursor-pointer", theme.border.default, `hover:${theme.surfaceHighlight}`)}>
            ...
            <div>
                ...
                <select className={cn("w-full text-sm rounded-md p-2 border", theme.border.default, theme.surfaceHighlight, theme.text.secondary)} disabled>
            ...
            <div>
                ...
                <div className="flex flex-wrap gap-2">
                    {['Damages', 'Liability', 'Key Witness', 'Timeline'].map(tag => (
                        <span key={tag} className={cn("px-2 py-1 rounded text-xs border cursor-pointer transition-colors", theme.surfaceHighlight, theme.border.default, theme.text.secondary, "hover:bg-blue-50 hover:text-blue-600")}>
                            {tag}
                        </span>
                    ))}
