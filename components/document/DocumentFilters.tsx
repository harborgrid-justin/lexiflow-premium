            ...
            <div className="space-y-0.5">
                {smartViews.map(sf => (
                    ...
                    >
                        ...
                        {sf.count && <span className={cn("text-[10px] px-1.5 py-0.5 rounded-full font-bold", theme.surface, theme.text.secondary)}>{sf.count}</span>}
                    </button>
                ))}
            </div>
        </div>
                        ...
                        <button 
                            ...
                            className={cn(
                                ...
                                isActive 
                                    ...
                                    : cn(theme.text.secondary, `hover:${theme.surface}`, `hover:${theme.primary.text}`)
                            )}
                        >
                ...
                <div key={idx} className="mb-6">
                    ...
                    <div className="space-y-0.5">
                        {facet.items.map(item => (
                            <div key={item.id} className={cn("flex items-center justify-between px-3 py-1.5 rounded cursor-pointer group", `hover:${theme.surface}`)}>
