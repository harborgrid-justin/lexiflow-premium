        ...
        <div className="p-6">
            ...
            <div className="mb-6">
                ...
                <div className="flex gap-2">
                    <input 
                        className={cn("flex-1 px-3 py-2 border rounded-md text-sm outline-none transition-all", theme.border.default, theme.surface, "focus:ring-2 focus:ring-blue-500")}
