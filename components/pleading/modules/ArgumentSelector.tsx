    ...
    <div className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar">
            ...
            {argumentsList.map((arg) => (
                <div key={arg.id} className={cn("p-3 rounded-lg border group hover:border-blue-400 hover:shadow-sm transition-all bg-white dark:bg-slate-800", theme.border.default)}>
                    <div className="flex justify-between items-start mb-2">
                        <div className="flex items-center gap-2">
                            <span className={cn("text-xs font-bold px-1.5 py-0.5 rounded bg-slate-100 dark:bg-slate-700", theme.text.primary)}>
