...
export const TaskReassignmentPanel: React.FC = () => {
  ...
  return (
    <div className={cn("p-6 rounded-lg border shadow-sm", theme.surface, theme.border.default)}>
      ...
      <div className={cn("flex flex-col md:flex-row gap-4 items-center p-4 rounded-lg border", theme.surfaceHighlight, theme.border.default)}>
        <div className="flex-1 w-full">
          <label className={cn("block text-xs font-bold uppercase mb-1", theme.text.secondary)}>From User</label>
          <div className={cn("flex items-center border rounded-md px-3 py-2", theme.surface, theme.border.default)}>
