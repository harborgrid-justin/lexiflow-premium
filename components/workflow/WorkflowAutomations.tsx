...
export const WorkflowAutomations: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 gap-6">
        ...
        <div className={cn("border-2 border-dashed rounded-xl p-8 flex flex-col items-center justify-center transition-all cursor-pointer", theme.border.default, theme.text.tertiary, `hover:${theme.primary.border}`, `hover:${theme.primary.text}`, `hover:${theme.surfaceHighlight}`)}>
