...
export const MOCK_DOCUMENTS: LegalDocument[] = [
    // NEW FORM DOCS
    {
        id: 'doc-form-nda', caseId: 'General', title: 'Standard NDA Template.pdf', type: 'PDF',
        ...
        versions: [], status: 'Final', fileSize: '128 KB', authorId: 'usr-admin-justin',
        formFields: [
    ...
    {
        id: 'doc-form-draft', caseId: 'C-2024-001', title: 'Engagement Letter - Martinez.pdf', type: 'PDF',
        ...
        versions: [], status: 'Draft', fileSize: '256 KB', authorId: 'usr-assoc-james',
        formFields: []
    },
    {
        id: 'doc-form-sent', caseId: 'C-2024-112', title: 'OmniGlobal Merger Agreement - Signature Packet.pdf', type: 'PDF',
        content: 'Merger agreement details...',
        uploadDate: '2024-03-15', lastModified: '2024-03-15', tags: ['Form', 'Local'],
        versions: [], status: 'Sent' as any, fileSize: '1.2 MB', authorId: 'usr-partner-alex',
        formFields: []
    },
    {
        id: 'doc-form-signed', caseId: 'C-2023-892', title: 'Settlement Agreement - GreenEnergy.pdf', type: 'PDF',
        content: 'Settlement details...',
        uploadDate: '2024-02-20', lastModified: '2024-02-21', tags: ['Form', 'Local'],
        versions: [], status: 'Signed' as any, fileSize: '800 KB', authorId: 'usr-partner-alex',
        formFields: []
    },
