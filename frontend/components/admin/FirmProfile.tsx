        ...
        <Card title={<span className="flex items-center gap-2"><Building2 className="h-4 w-4" />Basic Information</span>}>
          <div className="space-y-4">
            <Input 
              ...
              onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateField('name', e.target.value)}
              disabled={!isEditing}
            />
            <Input 
              label="Legal Name"
              value={firmDetails.legalName}
              onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateField('legalName', e.target.value)}
              disabled={!isEditing}
            />
            <Input 
              label="Tax ID / EIN"
              value={firmDetails.taxId}
              onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateField('taxId', e.target.value)}
              disabled={!isEditing}
              type="password"
            />
            <div className="grid grid-cols-2 gap-4">
              <Input 
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateField('foundedYear', parseInt(e.target.value) || 0)}
                disabled={!isEditing}
                type="number"
              />
              <Input 
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateField('attorneyCount', parseInt(e.target.value) || 0)}
                disabled={!isEditing}
                type="number"
              />
            </div>
        ...
        <Card title={<span className="flex items-center gap-2"><Mail className="h-4 w-4" />Contact Information</span>}>
          <div className="space-y-4">
            <Input 
              ...
              onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateField('website', e.target.value)}
              disabled={!isEditing}
            />
            <Input 
              label="Main Email"
              value={firmDetails.email}
              onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateField('email', e.target.value)}
              disabled={!isEditing}
              type="email"
            />
            <Input 
              ...
              onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateField('phone', e.target.value)}
              disabled={!isEditing}
            />
          </div>
        </Card>
        ...
        <Card title={<span className="flex items-center gap-2"><MapPin className="h-4 w-4" />Primary Office Address</span>}>
          <div className="space-y-4">
            <Input 
              ...
              onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateField('address.street', e.target.value)}
              disabled={!isEditing}
            />
            <div className="grid grid-cols-2 gap-4">
              <Input 
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateField('address.city', e.target.value)}
                disabled={!isEditing}
              />
              <Input 
                label="State"
                value={firmDetails.address.state}
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateField('address.state', e.target.value)}
                disabled={!isEditing}
              />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <Input 
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateField('address.zip', e.target.value)}
                disabled={!isEditing}
              />
              <Input 
                label="Country"
                value={firmDetails.address.country}
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateField('address.country', e.target.value)}
                disabled={!isEditing}
              />
            </div>
          </div>
