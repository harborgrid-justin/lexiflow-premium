...
import { GitCommit, Zap, Play, Pause, AlertCircle } from 'lucide-react';
...
export const EventBusManager: React.FC = () => {
  ...
  const [events] = useState<EventBusEvent[]>([
    {
      id: '1',
      event: 'case.created',
          ...
          <Card>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={cn("text-2xl font-bold mt-1", theme.text.primary)}>24,387</p>
              </div>
          ...
          <Card>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={cn("text-2xl font-bold mt-1", theme.text.primary)}>12</p>
              </div>
          ...
          <Card>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={cn("text-2xl font-bold mt-1", theme.text.primary)}>3</p>
              </div>
