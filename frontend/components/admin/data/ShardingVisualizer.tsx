                ...
                <div className={cn("p-4 rounded-lg border", theme.surface.default, theme.border.default)}>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input value={key} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setKey(e.target.value)} className={cn("w-full p-2 border rounded font-mono text-sm", theme.surface.input, theme.border.default, theme.text.primary)} />
                        </div>
