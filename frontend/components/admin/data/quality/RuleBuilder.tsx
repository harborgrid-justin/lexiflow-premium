            ...
            <div className={cn("flex-1 p-6 overflow-y-auto border-r", theme.border.default)}>
                <div className="space-y-6 max-w-2xl">
                    <div className="grid grid-cols-1 gap-6">
                        <Input label="Rule Name" value={rule.name} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setRule({...rule, name: e.target.value})} placeholder="e.g. Email Format Validation" />
                            ...
                            <div>
                             ...
                             <div>
                                ...
                                <select 
                                    ...
                                    value={rule.action}
                                    onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setRule({...rule, action: e.target.value as any})}
                                >
                            ...
                            {rule.conditions.map((cond, idx) => (
                                <div key={cond.id} className="flex gap-3 items-center">
                                    ...
                                    <input 
                                        ...
                                        value={cond.field}
                                        onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateCondition(cond.id, 'field', e.target.value)}
                                    />
                                    <select 
                                        className={cn("w-32 p-2 text-sm border rounded", theme.border.default, theme.surface.default, theme.text.primary)}
                                        value={cond.operator}
                                        onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateCondition(cond.id, 'operator', e.target.value)}
                                    >
                                        <option value="=">=</option>
                                        <option value="!=">!=</option>
                                        <option value=">">&gt;</option>
                                    ...
                                    <input 
                                        ...
                                        placeholder="Value"
                                        value={cond.value}
                                        onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateCondition(cond.id, 'value', e.target.value)}
                                    />
