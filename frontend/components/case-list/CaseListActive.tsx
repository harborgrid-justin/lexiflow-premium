    ...
    <div className="space-y-4 h-full flex flex-col">
      ...
      <FilterPanel isOpen={showFilters} onClose={toggleFilters} onClear={resetFilters}>
          ...
          <div>
              ...
              <select className={cn("w-full px-3 py-2 border rounded-md text-sm outline-none", theme.surface.default, theme.border.default, theme.text.primary)} value={statusFilter} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setStatusFilter(e.target.value)} aria-label="Status Filter">
          ...
          <div>
              ...
              <select className={cn("w-full px-3 py-2 border rounded-md text-sm outline-none", theme.surface.default, theme.border.default, theme.text.primary)} value={typeFilter} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setTypeFilter(e.target.value)} aria-label="Type Filter">
          ...
          <Input type="date" label="Filed After" value={dateFrom} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setDateFrom(e.target.value)} />
          <Input type="date" label="Filed Before" value={dateTo} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setDateTo(e.target.value)} />
      </FilterPanel>
