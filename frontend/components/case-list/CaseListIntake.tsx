      ...
      <Modal isOpen={leadModal.isOpen} onClose={leadModal.close} title="New Lead Intake">
        <div className="p-6 space-y-4">
          <Input 
            ...
            value={newLead.name || ''} 
            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setNewLead({...newLead, name: e.target.value, client: e.target.value})} 
            required
          />
          <Input 
            label="Contact Email" 
            ...
            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setNewLead({...newLead, contactEmail: e.target.value})} 
            required
          />
          <Input 
            label="Phone" 
            ...
            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setNewLead({...newLead, contactPhone: e.target.value})} 
          />
          <Input 
            label="Matter Title" 
            placeholder="Brief description of matter" 
            value={newLead.title || ''} 
            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setNewLead({...newLead, title: e.target.value})} 
          />
          <Input 
            ...
            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setNewLead({...newLead, value: `$${e.target.value}`})} 
          />
          <TextArea 
            label="Notes" 
            rows={4} 
