    ...
    <div className="grid grid-cols-2 gap-4">
      <div>
        ...
        <input
          ...
          onChange={(e) => onChange('leadAttorneyName', e.target.value)}
          className={`w-full px-3 py-2 bg-white dark:bg-slate-900 border rounded-lg ${
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => onChange('originatingAttorneyName', e.target.value)}
          className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-900 dark:text-slate-100"
    ...
    <div className="grid grid-cols-3 gap-4">
      <div>
        ...
        <input
          ...
          onChange={(e) => onChange('openedDate', e.target.value ? new Date(e.target.value).toISOString() : '')}
          className={`w-full px-3 py-2 bg-white dark:bg-slate-900 border rounded-lg ${
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => onChange('targetCloseDate', e.target.value ? new Date(e.target.value).toISOString() : undefined)}
          className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-900 dark:text-slate-100"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => onChange('statute_of_limitations', e.target.value ? new Date(e.target.value).toISOString() : undefined)}
          className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-900 dark:text-slate-100"
        />
      </div>
    </div>
    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => onChange('hourlyRate', e.target.value ? Number(e.target.value) : undefined)}
          className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-900 dark:text-slate-100"
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => onChange('budgetAmount', e.target.value ? Number(e.target.value) : undefined)}
          className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-900 dark:text-slate-100"
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => onChange('retainerAmount', e.target.value ? Number(e.target.value) : undefined)}
          className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-900 dark:text-slate-100"
