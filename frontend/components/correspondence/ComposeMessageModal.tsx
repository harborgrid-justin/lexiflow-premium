    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Compose Correspondence" size="lg">
        <div className="p-6 space-y-4">
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select 
                        ...
                        value={formData.type}
                        onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setFormData({...formData, type: e.target.value as CommunicationType})}
                    >
                ...
                <div>
                    ...
                    <select 
                        ...
                        onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setFormData({...formData, caseId: e.target.value})}
                    >
            ...
            <Input 
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setFormData({...formData, recipient: e.target.value})}
            />
            ...
            <Input 
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setFormData({...formData, subject: e.target.value})}
            />
                ...
                <div className="flex items-center gap-4">
                    ...
                    <label className="flex items-center text-sm cursor-pointer">
                        <input 
                            ...
                            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setFormData({...formData, isPrivileged: e.target.checked})}
                        />
                        Mark Privileged
                    </label>
                </div>
