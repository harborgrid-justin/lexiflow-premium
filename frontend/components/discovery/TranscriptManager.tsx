    ...
    <div className="space-y-6 animate-fade-in">
        ...
        <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="Import Transcript">
            <div className="p-6 space-y-4">
                <Input label="Deponent Name" value={newTranscript.deponent || ''} onChange={e => setNewTranscript({...newTranscript, deponent: e.target.value})}/>
                <Input type="date" label="Deposition Date" value={newTranscript.date || ''} onChange={e => setNewTranscript({...newTranscript, date: e.target.value})}/>
                <div className="flex items-center gap-2 pt-2">
                    <input type="checkbox" id="final" className="rounded text-blue-600" checked={newTranscript.isFinal || false} onChange={e => setNewTranscript({...newTranscript, isFinal: e.target.checked})}/>
