            ...
            <div className="flex flex-col md:flex-row justify-between gap-4">
                ...
                <div className="flex gap-2 overflow-x-auto pb-2 md:pb-0">
                    <select 
                        ...
                        onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setSelectedCategory(e.target.value)}
                        disabled={isLoading}
                    >
                    ...
                    <select 
                        ...
                        onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setSelectedDifficulty(e.target.value)}
                        disabled={isLoading}
                    >
