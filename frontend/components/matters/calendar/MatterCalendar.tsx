...
export const MatterCalendar: React.FC = () => {
  ...
  const { data: events, isLoading: eventsLoading } = useQuery(
    ...
    async (): Promise<CalendarEvent[]> => {
      // TODO: Create backend endpoint for calendar events
      return [
        {
          id: 'evt1',
          matterId: 'm1',
          matterTitle: 'Smith v. Acme Corp',
          title: 'Discovery Deadline',
          type: 'deadline',
          startTime: new Date(currentDate.getFullYear(), currentDate.getMonth(), 15, 17, 0).toISOString(),
          priority: 'high',
          status: 'scheduled',
          reminder: 1440,
        },
        {
          ...
          type: 'meeting',
          startTime: new Date(currentDate.getFullYear(), currentDate.getMonth(), 18, 10, 0).toISOString(),
          endTime: new Date(currentDate.getFullYear(), currentDate.getMonth(), 18, 11, 0).toISOString(),
        ...
        },
        {
          id: 'evt3',
          matterId: 'm3',
          matterTitle: 'Tech Startup M&A',
          title: 'Hearing - Motion to Compel',
          type: 'hearing',
          startTime: new Date(currentDate.getFullYear(), currentDate.getMonth(), 22, 14, 0).toISOString(),
          endTime: new Date(currentDate.getFullYear(), currentDate.getMonth(), 22, 15, 30).toISOString(),
          location: 'Superior Court, Dept. 4',
          priority: 'high',
          status: 'confirmed',
          reminder: 120,
        },
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className={cn('text-sm mt-1', theme === 'dark' ? 'text-slate-400' : 'text-slate-600')}>
              Deadlines, hearings, and key dates
            </p>
          </div>
