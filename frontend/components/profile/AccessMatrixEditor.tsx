    ...
    <div className="h-full flex flex-col p-6 animate-fade-in">
        ...
        <Modal isOpen={permModal.isOpen} onClose={permModal.close} title="Grant Granular Permission" size="md">
            <div className="p-6 space-y-4">
                <Input label="Resource Identifier" placeholder="e.g. billing.invoices" value={newPerm.resource || ''} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setNewPerm({...newPerm, resource: e.target.value})} />
                
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <label className="block text-xs font-bold uppercase mb-1 text-slate-500">Action</label>
                        <select className="w-full p-2 border rounded text-sm" value={newPerm.action} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setNewPerm({...newPerm, action: e.target.value as any})}>
                    ...
                    <div>
                        ...
                        <select className="w-full p-2 border rounded text-sm" value={newPerm.effect} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setNewPerm({...newPerm, effect: e.target.value as any})}>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select className="w-full p-2 border rounded text-sm" value={newPerm.scope} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setNewPerm({...newPerm, scope: e.target.value as any})}>
                    ...
                    <Input type="date" label="Expiration (Optional)" value={newPerm.expiration || ''} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setNewPerm({...newPerm, expiration: e.target.value})} />
                </div>
