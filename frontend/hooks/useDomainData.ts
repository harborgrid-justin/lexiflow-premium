...
// --- DATA PLATFORM / ADMIN ---
export const useSchemaTables = () => useQuery<SchemaTable[]>(
    ['schema', 'tables'],
    DataService.catalog.getSchemaTables
);

export const usePipelines = () => useQuery<PipelineJob[]>(
    ['admin', 'pipelines'],
    DataService.admin.getPipelines
);

export const useConnectors = () => useQuery<Connector[]>(
    ['admin', 'connectors'],
    DataService.admin.getConnectors
);

export const useDataDictionary = () => useQuery<DataDictionaryItem[]>(
    ['catalog', 'dictionary'],
