...
export class ReportsApiService {
  ...
  async getAll(filters?: { status?: Report['status']; reportType?: Report['reportType'] }): Promise<Report[]> {
  ...
  async updateTemplate(id: string, data: Partial<ReportTemplate>): Promise<ReportTemplate> {
    return apiClient.put<ReportTemplate>(`${this.baseUrl}/templates/${id}`, data);
  }
