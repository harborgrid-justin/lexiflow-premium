...
export const MOCK_API_SPEC: ApiServiceSpec[] = [
  {
    ...
    methods: [
        ...
        params: [
          {
            name: "id",
            type: "string",
            desc: "The unique case identifier (CaseId).",
          },
        ],
        response: JSON.stringify(
          {
      ...
      },
      {
        ...
        params: [
          { name: "caseData", type: "Case", desc: "The full case object." },
        ],
        response: JSON.stringify(
          {
            id: "C-2024-002",
        ...
        params: [
          {
            name: "id",
            type: "string",
            desc: "The unique document identifier.",
          },
        ],
  ...
  },
  {
    ...
    methods: [
        ...
        params: [
          {
            ...
            desc: "Filter entries by a specific case.",
          },
        ],
        response: JSON.stringify(
          [
      ...
      },
      {
        ...
        description:
          "Generates a new invoice from a set of unbilled time entries.",
        params: [
          {
            name: "timeEntryIds",
            type: "string[]",
            desc: "Array of time entry IDs to include.",
          },
        ],
        response: JSON.stringify(
          {
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        params: [
          { name: "caseId", type: "string", desc: "The case identifier." },
        ],
        response: JSON.stringify(
          [
            {
              ...
              desc: "Legal advice re: termination.",
            },
          ],
          null,
          2
