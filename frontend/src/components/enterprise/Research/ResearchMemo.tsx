/**
 * @module enterprise/Research/ResearchMemo
  ...
  return (
    <div className={`flex h-full flex-col ${className}`}>
        ...
        <div className="mb-4 flex items-start justify-between">
          <div className="flex-1">
            <input
              ...
              className="mb-2 w-full border-0 bg-transparent text-2xl font-bold text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-0 dark:text-gray-100"
            ...
            <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400">
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="border-0 border-b border-gray-300 bg-transparent px-0 py-0 text-sm focus:border-blue-500 focus:outline-none focus:ring-0 dark:border-gray-600"
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-md border border-gray-300 bg-white px-3 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
            >
            ...
            <div className="relative">
              <button className="inline-flex items-center gap-2 rounded-md border border-gray-300 bg-white px-3 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Section Navigation */}
        <div className="w-64 border-r border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-800/50">
          <div className="p-4">
            ...
            <button className="mt-4 flex w-full items-center gap-2 rounded-md border border-dashed border-gray-300 px-3 py-2 text-sm text-gray-600 hover:border-gray-400 hover:text-gray-700 dark:border-gray-600 dark:text-gray-400 dark:hover:text-gray-300">
          ...
          <div className="border-t border-gray-200 p-4 dark:border-gray-700">
            <div className="text-xs text-gray-500 dark:text-gray-500">
              <div className="mb-1 flex items-center gap-2">
                ...
                <span>Last saved: {memo.updatedAt.toLocaleTimeString()}</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            {activeView === 'edit' && currentSection && (
              ...
              >
                <div className="mx-auto max-w-4xl">
                  ...
                  {/* Editor Toolbar */}
                  <div className="mb-4 flex gap-1 rounded-lg border border-gray-200 bg-white p-2 dark:border-gray-700 dark:bg-gray-800">
                    <button className="rounded p-2 text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">
                      <Bold className="h-4 w-4" />
                    </button>
                    <button className="rounded p-2 text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">
                      <Italic className="h-4 w-4" />
                    </button>
                    <div className="mx-2 w-px bg-gray-200 dark:bg-gray-700" />
                    <button className="rounded p-2 text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">
                  ...
                  <textarea
                    ...
                    className="min-h-[500px] w-full rounded-lg border border-gray-300 bg-white p-4 font-serif text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
                  ...
                  <div className="rounded-lg border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    <div className="mb-8 border-b border-gray-200 pb-6 dark:border-gray-700">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-400">
                        {memo.client && (
                          <div>
                            <span className="font-medium">Client:</span> {memo.client}
                          </div>
                        )}
                        {memo.matter && (
                          <div>
                            <span className="font-medium">Matter:</span> {memo.matter}
                          </div>
                        )}
                        <div>
                          <span className="font-medium">Author:</span> {memo.author.name}
                        </div>
                        <div>
                    ...
                    {memo.sections
                      ...
                      .map((section) => (
                        <div key={section.id} className="mb-8">
                          ...
                          <div className="whitespace-pre-wrap font-serif leading-relaxed text-gray-700 dark:text-gray-300">
                            {section.content || (
        ...
        <AnimatePresence>
          {showAIPanel && (
            <motion.div
              ...
              className="border-l border-gray-200 bg-gradient-to-b from-purple-50 to-blue-50 dark:border-gray-700 dark:from-purple-900/20 dark:to-blue-900/20"
            >
              <div className="flex h-full flex-col p-4">
                ...
                <div className="mb-4 space-y-2">
                  <button
                    ...
                    className="flex w-full items-center gap-2 rounded-lg border border-purple-200 bg-white p-3 text-left text-sm hover:bg-purple-50 disabled:opacity-50 dark:border-purple-800 dark:bg-gray-800 dark:hover:bg-purple-900/20"
                  >
                    <Sparkles className="h-4 w-4 text-purple-600 dark:text-purple-400" />
                    <div>
                      <div className="font-medium text-gray-900 dark:text-gray-100">
                        {isAISummarizing ? 'Summarizing...' : 'Summarize Section'}
                      </div>
                  ...
                  <button className="flex w-full items-center gap-2 rounded-lg border border-purple-200 bg-white p-3 text-left text-sm hover:bg-purple-50 dark:border-purple-800 dark:bg-gray-800 dark:hover:bg-purple-900/20">
                    <Sparkles className="h-4 w-4 text-purple-600 dark:text-purple-400" />
                    <div>
                      <div className="font-medium text-gray-900 dark:text-gray-100">
