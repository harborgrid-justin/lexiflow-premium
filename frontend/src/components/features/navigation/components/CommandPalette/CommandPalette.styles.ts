...
export const getPaletteContainer = (theme: Theme) => cn(
...
export const getSearchContainer = (theme: Theme) => cn(
  "flex items-center gap-3 px-4 py-3 border-b",
  theme.border.default
);

export const searchIcon = cn(
  "h-5 w-5 shrink-0 opacity-40"
);
...
export const getShortcutKey = (theme: Theme) => cn(
...
export const getGroupLabel = (theme: Theme) => cn(
  "px-4 py-2 text-xs font-bold uppercase tracking-wider sticky top-0 backdrop-blur-sm",
  theme.text.tertiary,
  theme.surface.default
);

export const getCommandItem = (theme: Theme, isSelected: boolean) => cn(
...
export const getCommandLabel = (theme: Theme) => cn(
  "text-sm font-medium truncate",
  theme.text.primary
);

export const getCommandDescription = (theme: Theme) => cn(
...
export const getEmptyStateText = (theme: Theme) => cn(
  "text-sm font-medium mb-1",
  theme.text.secondary
);

export const getEmptyStateHint = (theme: Theme) => cn(
  "text-xs",
  theme.text.tertiary
);

export const getFooter = (theme: Theme) => cn(
...
export const getFooterHint = (theme: Theme) => cn(
