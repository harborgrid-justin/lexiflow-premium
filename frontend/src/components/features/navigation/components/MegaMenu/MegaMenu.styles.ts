...
export const getTriggerButton = (theme: Theme, isOpen: boolean, disabled: boolean) => cn(
...
export const getFeaturedItem = (theme: Theme) => cn(
...
export const getFeaturedIconContainer = (theme: Theme) => cn(
...
export const featuredItemHeader = "flex items-center justify-between gap-2 mb-1";

export const getFeaturedItemLabel = (theme: Theme) => cn(
  "text-sm font-bold truncate",
  theme.text.primary
);

export const getFeaturedItemDescription = (theme: Theme) => cn(
...
export const getSectionTitle = (theme: Theme) => cn(
...
export const getMenuItem = (theme: Theme) => cn(
...
export const getMenuItemLabel = (theme: Theme) => cn(
  "text-sm font-medium truncate",
  theme.text.primary
);

export const getMenuItemDescription = (theme: Theme) => cn(
