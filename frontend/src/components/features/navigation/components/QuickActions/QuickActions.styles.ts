...
export const getTriggerButton = (theme: Theme, disabled: boolean) => cn(
...
export const getHeader = (theme: Theme) => cn(
  "flex items-center justify-between px-4 py-3 border-b",
  theme.border.default
);

export const getHeaderTitle = (theme: Theme) => cn(
  "text-sm font-bold",
  theme.text.primary
);

export const getCloseButton = (theme: Theme) => cn(
...
export const getGroupTitle = (theme: Theme) => cn(
...
export const getActionButton = (theme: Theme, disabled: boolean) => cn(
...
export const getActionLabel = (theme: Theme) => cn(
  "text-sm font-medium truncate",
  theme.text.primary
);

export const getActionDescription = (theme: Theme) => cn(
...
export const getDivider = (theme: Theme) => cn(
  "mx-4 my-2 h-px",
  theme.border.default
);
