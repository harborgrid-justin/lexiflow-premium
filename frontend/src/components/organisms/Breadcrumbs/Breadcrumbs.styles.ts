...
export const getBreadcrumbsContainer = (theme: Theme) =>
  cn("flex items-center py-2 px-1", theme.text.secondary);

export const breadcrumbsList = "flex items-center flex-wrap gap-1";

export const breadcrumbItem = "flex items-center";

export const separator = cn("flex items-center opacity-40 mx-0.5");

export const getBreadcrumbButton = (
  theme: Theme,
  isLast: boolean,
  isHome: boolean
) =>
...
export const getBreadcrumbText = (theme: Theme, isLast: boolean) =>
  cn(
