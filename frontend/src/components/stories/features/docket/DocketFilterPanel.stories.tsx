...
const mockCases: Case[] = [
  {
    ...
    client: 'John Smith',
    parties: [
      { id: 'party-1' as any, name: 'John Smith', type: 'Plaintiff', role: 'Primary', caseId: 'case-1' as any, createdAt: '', updatedAt: '' },
      { id: 'party-2' as any, name: 'Acme Corporation', type: 'Defendant', role: 'Primary', caseId: 'case-1' as any, createdAt: '', updatedAt: '' },
    ],
    citations: [],
    arguments: [],
    defenses: [],
  ...
  },
  {
    ...
    parties: [
      { id: 'party-3' as any, name: 'Johnson Industries', type: 'Plaintiff', role: 'Primary', caseId: 'case-2' as any, createdAt: '', updatedAt: '' },
      { id: 'party-4' as any, name: 'XYZ Corp', type: 'Defendant', role: 'Primary', caseId: 'case-2' as any, createdAt: '', updatedAt: '' },
    ],
    citations: [],
    arguments: [],
    defenses: [],
  ...
  },
  {
    ...
    parties: [
      { id: 'party-5' as any, name: 'United States of America', type: 'Plaintiff', role: 'Primary', caseId: 'case-3' as any, createdAt: '', updatedAt: '' },
      { id: 'party-6' as any, name: 'David Anderson', type: 'Defendant', role: 'Primary', caseId: 'case-3' as any, createdAt: '', updatedAt: '' },
    ],
    citations: [],
    arguments: [],
    defenses: [],
