...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const DafDashboard = lazyWithPreload(() => import('../features/operations/daf/DafDashboard').then(m => ({ default: m.DafDashboard })) as Promise<{ default: React.ComponentType<any> }>);
