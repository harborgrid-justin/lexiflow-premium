...
export const ANALYTICS_TAB_CONFIG: TabConfigItem[] = [
  ...
  },
  {
    ...
    icon: BrainCircuit,
    subTabs: [{ id: "outcomes", label: "Case Outcomes", icon: BrainCircuit }],
  },
];
...
export const BILLING_TAB_CONFIG: TabConfigItem[] = [
  ...
  },
  {
    ...
    label: "Analytics",
    icon: BarChart2,
    subTabs: [{ id: "analytics", label: "Revenue Analytics", icon: BarChart2 }],
  },
];
...
export const CASE_LIST_TAB_CONFIG: TabConfigItem[] = [
  {
    id: "cases",
    label: "Cases",
    icon: Briefcase, // Consolidated: matters -> cases
    subTabs: [
  ...
  },
  {
    ...
    label: "Financials",
    icon: DollarSign,
    subTabs: [{ id: "trust", label: "Trust Accounts", icon: DollarSign }],
  },
  {
    id: "archive",
    label: "Archives",
...
export const COMPLIANCE_TAB_CONFIG: TabConfigItem[] = [
  ...
  },
  {
    ...
    label: "Clearance",
    icon: ShieldAlert,
    subTabs: [{ id: "conflicts", label: "Conflict Checks", icon: ShieldAlert }],
  },
  {
    id: "barriers",
    label: "Information Barriers",
    icon: Lock,
    subTabs: [{ id: "walls", label: "Ethical Walls", icon: Lock }],
  },
];
...
export const DOCUMENT_MANAGER_TAB_CONFIG: TabConfigItem[] = [
  ...
  },
  {
    ...
    label: "Drafting",
    icon: LayoutTemplate,
    subTabs: [{ id: "templates", label: "Templates", icon: LayoutTemplate }],
  },
  {
    id: "tools",
    label: "Tools",
...
export const PLEADING_BUILDER_TAB_CONFIG: TabConfigItem[] = [
  ...
  },
  {
    ...
    label: "Tools",
    icon: Library,
    subTabs: [{ id: "clauses", label: "Clause Library", icon: Library }],
  },
  {
    id: "filing",
    label: "Filing",
...
export const RESEARCH_TAB_CONFIG: TabConfigItem[] = [
  ...
  },
  {
    ...
    label: "Config",
    icon: Settings,
    subTabs: [{ id: "settings", label: "Jurisdictions", icon: Gavel }],
  },
];
