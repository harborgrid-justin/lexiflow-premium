...
import { TabConfigItem } from '@/components/templates/TabbedPageLayout';
...
export type MatterView = 'overview' | 'operations' | 'intake' | 'calendar' | 'financials' | 'insights' | 'analytics';
...
export const MATTER_MANAGEMENT_TAB_CONFIG: TabConfigItem[] = [
  ...
  {
    id: 'planning_group', label: 'Planning', icon: Settings,
    subTabs: [
  ...
  {
    id: 'analytics_group', label: 'Analytics', icon: BarChart3,
    subTabs: [
