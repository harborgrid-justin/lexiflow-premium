/**
 * ================================================================================
 * THEME CONTEXT - APP-LEVEL INFRASTRUCTURE
 * ================================================================================
 *
 * Enterprise React Architecture - Context Layer
 * Theme management context following React 18 concurrent-safe patterns.
 *
 * ARCHITECTURE PLACEMENT:
 * /contexts/ → App-level contexts (Theme, Auth, Permissions)
 *
