...
export const ThemeProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // Sync tokens with mode changes
  useEffect(() => {
    const mode = isDark ? 'dark' : 'light';
    // Regenerate tokens for the new mode, preserving fontMode
    // Note: This overrides manual token customizations for now to ensure theme consistency
