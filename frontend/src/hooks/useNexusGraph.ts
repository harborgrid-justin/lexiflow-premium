...
// ============================================================================
// Utils & Constants
import { SerializedNode, NODE_STRIDE, NexusLink, NexusPhysics, SimulationNode } from '@/utils';
    ...
    const processedLinks: NexusLink[] = initialData.links
        .map(l => {
            ...
            if (sIdx !== undefined && tIdx !== undefined) {
                return { sourceIndex: sIdx, targetIndex: tIdx, strength: (l as Record<string, unknown>).strength || 1 };
            }
            return null;
        })
