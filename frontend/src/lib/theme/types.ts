 ...
 */
export interface ThemeContextType extends ThemeStateValue, ThemeActionsValue {}
...
// Re-export ThemeObject for backward compatibility
export type { ThemeObject as ThemeContextValue };
