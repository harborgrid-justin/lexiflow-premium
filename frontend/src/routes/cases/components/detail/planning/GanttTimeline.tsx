...
export const GanttTimeline: React.FC<GanttTimelineProps> = ({
    ...
    const { onMouseDown } = useScheduleController({
        pixelsPerDay,
        tasks,
    ...
    const renderTimeScale = () => {
        ...
        const days = ScheduleHelpers.generateTimeScale(viewStartDate, 90, step);
                                ...
                                {tasks.filter(() => true).slice(0, 10).map((task) => (
                                    ...
                                    >
                                        <div
                                            ...
                                            style={ScheduleHelpers.getTaskStyle(task, viewStartDate, pixelsPerDay)}
