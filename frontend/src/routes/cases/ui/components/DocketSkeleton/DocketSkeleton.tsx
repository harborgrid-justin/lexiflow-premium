/**
 * @module components/common/DocketSkeleton
...
export const DocketTableSkeleton: React.FC<{ rows?: number }> = ({ rows = 10 }) => {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header */}
      <div className={cn("hidden md:flex items-center px-6 py-3 border-b shrink-0", theme.surface.highlight, theme.border.default)}>
        <div className="w-20 h-3 bg-slate-200 dark:bg-slate-700 rounded animate-pulse shrink-0" />
        <div className="w-24 h-3 bg-slate-200 dark:bg-slate-700 rounded animate-pulse shrink-0 ml-6" />
        <div className="w-32 h-3 bg-slate-200 dark:bg-slate-700 rounded animate-pulse shrink-0 ml-6" />
        <div className="flex-1 h-3 bg-slate-200 dark:bg-slate-700 rounded animate-pulse ml-6" />
    ...
    <div className={cn("flex flex-col h-full rounded-lg border shadow-sm overflow-hidden", theme.surface.default, theme.border.default)}>
      ...
      <div className={cn("p-4 border-b flex justify-between items-center", theme.surface.highlight, theme.border.default)}>
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="w-32 h-5 bg-slate-200 dark:bg-slate-700 rounded animate-pulse mb-2" />
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      {Array.from({ length: 4 }).map((_, i) => (
        ...
        >
          <div className="w-24 h-3 bg-slate-200 dark:bg-slate-700 rounded animate-pulse mb-3" />
          <div className="w-16 h-8 bg-slate-200 dark:bg-slate-700 rounded animate-pulse mb-2" />
