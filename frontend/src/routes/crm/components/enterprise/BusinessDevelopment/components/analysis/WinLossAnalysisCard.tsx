...
export const WinLossAnalysisCard: React.FC<WinLossAnalysisCardProps> = React.memo(({ analysis }) => {
...
WinLossAnalysisCard.displayName = 'WinLossAnalysisCard';
