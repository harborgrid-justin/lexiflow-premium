...
export const LitigationProperties: React.FC<LitigationPropertiesProps> = ({
  ...
  // LAYOUT-STABLE: Render with consistent structure (hidden via CSS) instead of conditional null
  // This prevents layout shift when panel appears/disappears
  if (!isOpen) {
    return (
      <div className="hidden" aria-hidden="true">
        {/* Preserve DOM structure for hydration consistency */}
      </div>
    );
  }
