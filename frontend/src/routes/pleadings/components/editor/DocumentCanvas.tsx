...
export const DocumentCanvas: React.FC<DocumentCanvasProps> = ({
    ...
    return (
        <div
            ...
            className="w-[8.5in] min-h-[11in] shadow-2xl p-[1in] relative transition-all"
                    ...
                    {selectedSectionId === section.id && (
                        <div className="absolute -right-10 top-0 flex flex-col gap-1">
                            <button
                                ...
                                style={{ backgroundColor: 'var(--color-surface)' }}
                                className="p-2 shadow rounded-full text-red-500 hover:bg-red-50"
                            ...
                            <button
                                ...
                                className="p-2 shadow rounded-full cursor-grab active:cursor-grabbing"
