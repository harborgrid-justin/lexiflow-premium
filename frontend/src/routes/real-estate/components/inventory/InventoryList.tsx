import type { PropertyStatus } from '@/services/domain/RealEstateDomain';
import { Building2, CheckCircle, Clock, Plus } from 'lucide-react';
import { useState } from 'react';
import { Form, Link, useNavigate } from 'react-router';
import type { InventoryLoaderData } from './types';

export function InventoryList({ data, stats }: InventoryLoaderData) {
