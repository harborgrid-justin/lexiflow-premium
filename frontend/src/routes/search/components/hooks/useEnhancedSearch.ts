...
import { useKeyboardNav, useSearchHandlers } from '../components/advanced/hooks';
import { getRecentSearches, parseSearchSyntax } from '../components/advanced/storage';
import type { EnhancedSearchProps, SearchCategory, SearchResult } from '../components/advanced/types';
import { filterSuggestions, highlightMatch } from '../components/advanced/utils';
...
export const useEnhancedSearch = ({
...
}: Pick<EnhancedSearchProps, 'onSearch' | 'onSuggestionSelect' | 'suggestions' | 'debounceDelay'>) => {
    ...
    const filteredSuggestions = useMemo(() => {
        ...
        return filterSuggestions(categoryFiltered, deferredQuery, SEARCH_CONFIG.maxSuggestions);
