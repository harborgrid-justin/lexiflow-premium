      ...
      <div className="px-4 pb-4 space-y-4">
        <div className="flex gap-4 items-center">
          <div className="flex-1">
            <label htmlFor={searchId} className="sr-only">Search workflows</label>
            <input
              id={searchId}
              type="search"
      ...
      <div className="flex items-center justify-between">
        <div className="flex-1">
          ...
          <div className="text-sm text-slate-600 dark:text-slate-400 mt-1">
            Case: {instance.caseId} • Started {new Date(instance.startedAt).toLocaleDateString()}
          </div>
        </div>
        <div className="flex items-center gap-4">
          <div className="text-right">
            <div className="text-sm font-medium text-slate-900 dark:text-white">
              {instance.completedSteps || 0}/{instance.totalSteps || 0}
            </div>
      ...
      <div className="flex items-center justify-between">
        <div className="flex-1">
          ...
          <div className="text-sm text-slate-600 dark:text-slate-400 mt-1">
            {task.description}
            {task.dueDate && (
              <span className={isOverdue ? 'text-rose-600 dark:text-rose-400 ml-2' : 'ml-2'}>
