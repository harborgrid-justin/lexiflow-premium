...
export const VALIDATION_MESSAGES = {
  ...
  MISSING_DECISION_PORTS:
    "Decision nodes must have at least one outgoing connection per port",
...
/**
 * Node Type Colors (Theme-based CSS variables + fallback Tailwind)
 */
...
// TODO: Migrate to CSS variables when workflow canvas supports dynamic theming
