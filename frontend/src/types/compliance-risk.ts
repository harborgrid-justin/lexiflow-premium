...
export interface ConflictCheck extends BaseEntity {
  entityName: string;
  date: string;
  status: string;
  foundIn: string[];
...
export interface EthicalWall extends BaseEntity {
  caseId: CaseId;
  title: string;
  restrictedGroups: GroupId[];
...
export interface FirmAsset extends BaseEntity {
  name: string;
  type: string;
  assignedTo: string;
  status: string;
