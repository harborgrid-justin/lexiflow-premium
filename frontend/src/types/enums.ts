...
// Backend CaseType enum (from cases/entities/case.entity.ts)
...
export type ExpenseStatus =
  (typeof ExpenseStatusEnum)[keyof typeof ExpenseStatusEnum];
...
export type LegacyTrustAccountStatus =
  (typeof TrustAccountStatusEnum)[keyof typeof TrustAccountStatusEnum];
...
export type DiscoveryRequestStatusType =
  (typeof DiscoveryRequestStatusEnum)[keyof typeof DiscoveryRequestStatusEnum];
...
export type ESICollectionStatusType =
  (typeof ESICollectionStatusEnum)[keyof typeof ESICollectionStatusEnum];
...
export type LegalHoldStatusType =
  (typeof LegalHoldStatusEnum)[keyof typeof LegalHoldStatusEnum];
...
export type PrivilegeBasisType =
  (typeof PrivilegeBasisEnum)[keyof typeof PrivilegeBasisEnum];
...
export type AdmissibilityStatusType =
  (typeof AdmissibilityStatusEnum)[keyof typeof AdmissibilityStatusEnum];
...
export type CustodyActionTypeValue =
  (typeof CustodyActionType)[keyof typeof CustodyActionType];

export type ConferralResult =
  | "Agreed"
  | "Impasse"
  | "Partial Agreement"
  | "Pending";
export type ConferralMethod =
  | "Email"
  | "Phone"
  | "In-Person"
  | "Video Conference";
