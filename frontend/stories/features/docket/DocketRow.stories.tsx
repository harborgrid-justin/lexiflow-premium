...
import { DocketRow } from '../components/matters/docket/DocketRow';
...
const mockFilingEntry: DocketEntry = {
  ...
  documentIds: ['doc-1', 'doc-2'] as any[],
  isSealed: false,
  tags: ['Motion', 'Dispositive'],
...
const mockHearingEntry: DocketEntry = {
  ...
  documentIds: ['doc-4'] as any[],
  isSealed: false,
  tags: ['Hearing', 'Summary Judgment'],
