                 ...
                 <div className="space-y-4">
                     <div className="flex gap-3 p-4 border rounded">
                         ...
                         <div className="flex-1">
                             ...
                             <button className="mt-2 text-xs bg-slate-900 text-white px-3 py-1 rounded hover:bg-slate-800 transition-colors" onClick={() => alert("Firewall rules updated successfully.")}>Save Rules</button>
                         </div>
                     </div>
                 </div>
            </Card>
