...
import { ThemeDensity, useTheme } from '../providers/ThemeProvider.tsx';
...
const ColorInput: React.FC<{
    ...
    <div style={{ backgroundColor: 'var(--color-surface)', borderColor: 'var(--color-border)' }} className="flex items-center gap-4 p-3 border rounded-lg hover:border-blue-300 transition-all group">
        ...
        <div className="flex-1 min-w-0">
            <div className="flex justify-between items-center mb-0.5">
                ...
                <span style={{ backgroundColor: 'var(--color-surfaceHover)', color: 'var(--color-textMuted)' }} className="text-[10px] font-mono px-1.5 py-0.5 rounded uppercase">{value}</span>
            </div>
...
const RangeInput: React.FC<{
    ...
    return (
        <div style={{ backgroundColor: 'var(--color-surface)', borderColor: 'var(--color-border)' }} className="p-4 border rounded-lg">
    ...
    <div className="space-y-1.5">
        ...
        <div className="relative">
            <select
                ...
                className="w-full p-2.5 border rounded-lg text-sm appearance-none focus:ring-2 focus:ring-blue-500 outline-none transition-shadow font-medium"
            >
                {options.map(opt => (
            ...
            {standalone && (
                <div className="px-6 pt-6 pb-2 shrink-0">
                    ...
                    <TabNavigation
                        ...
                        className="rounded-xl border p-1 shadow-sm mb-4"
                    />
                </div>
            )}
                ...
                <div className="max-w-[1920px] mx-auto grid grid-cols-1 xl:grid-cols-3 gap-8">
                    ...
                    <div className="xl:col-span-2 space-y-6">
                        ...
                        {activeTab === 'typography' && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-left-4">
                                ...
                                <div style={{ backgroundColor: 'var(--color-surface)', borderColor: 'var(--color-border)' }} className="rounded-xl border overflow-hidden shadow-sm">
                        ...
                        {activeTab === 'geometry' && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-left-4">
                                ...
                                <Card title="Depth & Elevation (Shadows)">
                                    <div style={{ backgroundColor: 'var(--color-surfaceHover)' }} className="p-8 rounded-lg grid grid-cols-2 md:grid-cols-4 gap-8 justify-items-center">
                                        {['sm', 'md', 'lg', 'xl'].map((size) => (
                                            <div key={size} style={{ backgroundColor: 'var(--color-surface)', color: 'var(--color-textMuted)', boxShadow: (tokens.shadows as any)[size] }} className="w-24 h-24 rounded-lg flex items-center justify-center text-xs font-bold">
                                                {size.toUpperCase()}
                                            </div>
                                        ))}
                                    </div>
                        ...
                        {activeTab === 'layout' && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-left-4">
                                <div style={{ backgroundColor: 'var(--color-surface)', color: 'var(--color-text)' }} className="p-6 rounded-2xl flex flex-col md:flex-row justify-between items-center shadow-xl">
                                    <div>
                                    ...
                                    <div style={{ backgroundColor: 'var(--color-surfaceHover)' }} className="flex p-1 rounded-xl mt-4 md:mt-0">
                    ...
                    <div className="xl:col-span-1">
                        <div className="sticky top-6 space-y-6">
                            <div style={{ backgroundColor: 'var(--color-surface)', borderColor: 'var(--color-border)' }} className="rounded-2xl border shadow-lg overflow-hidden">
                            ...
                            <div style={{ backgroundColor: 'var(--color-surface)', color: 'var(--color-textMuted)', borderColor: 'var(--color-border)' }} className="p-4 rounded-xl text-xs font-mono border">
                                <div className="flex justify-between items-center mb-2">
