  ...
  return (
    <div className="flex items-center gap-1 p-2 border-b border-slate-200 bg-slate-50 flex-wrap">
      <div className="flex items-center gap-0.5 border-r border-slate-300 pr-2 mr-2">
        <select className="bg-transparent text-sm font-medium text-slate-700 h-8 border-none outline-none cursor-pointer hover:bg-slate-200 rounded px-1" onChange={(e) => onCmd('formatBlock', e.target.value)}>
