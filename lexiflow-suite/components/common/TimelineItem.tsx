...
import { DateText } from './Primitives.tsx';
...
export const TimelineItem: React.FC<TimelineItemProps> = ({ 
  ...
  return (
    <div className="relative pl-10 pb-10 group">
      ...
      {!isLast && (
        <div className="absolute left-[13px] top-6 bottom-0 w-[1px] bg-slate-200 group-hover:bg-blue-300 transition-colors duration-300"></div>
      )}
      ...
      >
        ...
        {description && (
          <div className="mt-2 relative">
             <p className="text-[12px] text-slate-500 leading-relaxed line-clamp-3 group-hover:line-clamp-none transition-all duration-300 bg-slate-50/50 p-2.5 rounded-lg border border-transparent group-hover:border-slate-100 group-hover:bg-white group-hover:shadow-sm">
                {description}
             </p>
          </div>
        )}
