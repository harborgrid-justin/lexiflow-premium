    ...
    <div className="flex flex-col h-full bg-slate-50">
      <div className="p-4 border-b border-slate-200 bg-white">
        ...
        <div className="relative">
          ...
          <input 
            className="w-full pl-9 pr-4 py-2 bg-slate-100 border border-transparent focus:bg-white focus:border-blue-300 focus:ring-4 focus:ring-blue-500/10 rounded-lg text-sm outline-none transition-all placeholder:text-slate-400 font-medium"
