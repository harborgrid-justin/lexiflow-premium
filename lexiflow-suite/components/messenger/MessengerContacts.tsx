...
import { Search, MessageSquare, Briefcase, User } from 'lucide-react';
    ...
    <div className="w-full flex flex-col h-full bg-white">
      <div className="p-4 border-b border-slate-200 flex justify-between items-center bg-slate-50/50">
        ...
        <div className="relative w-64">
          ...
          <input 
            className="w-full pl-9 pr-4 py-2 border border-slate-300 bg-white rounded-md text-sm outline-none focus:ring-2 focus:ring-blue-500 transition-shadow"
