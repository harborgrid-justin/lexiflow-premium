      ...
      <div className="overflow-auto flex-1 p-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredFiles.map((file, idx) => (
            <div key={idx} className="flex items-start p-4 border rounded-lg hover:bg-slate-50 transition-colors group">
              ...
              <button className="p-2 text-slate-400 hover:text-blue-600 rounded-full hover:bg-white opacity-0 group-hover:opacity-100 transition-all shadow-sm border border-transparent hover:border-slate-200">
