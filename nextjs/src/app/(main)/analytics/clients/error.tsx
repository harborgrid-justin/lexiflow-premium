...
/**
 * Client Analytics Error Boundary
 */
...
export default function ClientAnalyticsError({ error, reset }: ErrorProps): React.JSX.Element {
  useEffect(() => {
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 p-4 dark:bg-slate-900">
      <div className="w-full max-w-md text-center">
        ...
        <h1 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">
          Client Analytics Unavailable
        </h1>
        <p className="mb-6 text-sm text-slate-500 dark:text-slate-400">
          Unable to load client analytics data. Please try again.
        </p>
