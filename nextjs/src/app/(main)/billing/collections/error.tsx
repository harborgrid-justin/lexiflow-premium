 ...
 *
 * Error boundary component for the collections management page.
 * Provides user-friendly error display and recovery options.
 *
 * @module billing/collections/error
 */
      ...
      <div className="flex min-h-[60vh] flex-col items-center justify-center px-6">
        <div className="max-w-md text-center">
          ...
          <p className="mb-6 text-slate-600 dark:text-slate-400">
            There was an error loading the collections management data.
