...
export async function generateMetadata({
  ...
  try {
    const request: any = await apiFetch(API_ENDPOINTS.PRODUCTION_REQUESTS.DETAIL(id));
    return {
...
export default async function ProductionRequestDetailPage({ params }: ProductionRequestDetailPageProps) {
  const { id } = await params;
