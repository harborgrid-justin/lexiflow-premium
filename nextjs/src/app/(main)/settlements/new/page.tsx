...
export const metadata: Metadata = {
  title: 'New Settlement | Settlements | LexiFlow',
  description: 'Record a new settlement offer or agreement',
};
  ...
  return (
    <>
      <PageHeader
        ...
        description="Track settlement offers and agreements"
        breadcrumbs={[
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      ...
                      <option value="structured">Structured Settlement</option>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="countered">Counter-Offer Made</option>
                      <option value="accepted">Accepted</option>
                      <option value="rejected">Rejected</option>
                      <option value="finalized">Finalized & Paid</option>
                    </select>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-50"
                    >
                      <option value="us">Us (Client)</option>
                      <option value="opponent">Opposing Party</option>
                      <option value="mediator">Mediator Proposal</option>
                    </select>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    name="terms"
                    rows={4}
                    placeholder="Enter details about the offer terms..."
                    className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-50"
                  />
                </div>
