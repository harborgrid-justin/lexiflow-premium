...
/**
 * API Route Handler
 * Handles /api/auth/logout operations
 *
 * POST /api/auth/logout - Create resource
 * GET /api/auth/logout - Get resource
 * PUT /api/auth/logout - Update resource
 * PATCH /api/auth/logout - Partial update resource
 * DELETE /api/auth/logout - Delete resource
 *
...
// Validate required fields
    ...
    // Log request
    console.log(`[API] POST /api/auth/logout - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Log request
    console.log(`[API] GET /api/auth/logout - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
    ...
    console.error(`[API] GET /api/auth/logout error:`, error);
    return NextResponse.json(
      { error: 'Internal Server Error', code: 'INTERNAL_ERROR', message: 'An unexpected error occurred' },
      {
        status: 500,
...
// Validate content type
    ...
    // Log request
    console.log(`[API] PUT /api/auth/logout - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
    ...
    console.error(`[API] PUT /api/auth/logout error:`, error);
    return NextResponse.json(
      { error: 'Internal Server Error', code: 'INTERNAL_ERROR', message: 'An unexpected error occurred' },
      {
        status: 500,
...
// For PATCH, body can be partial, but should not be empty
    ...
    // Log request
    console.log(`[API] PATCH /api/auth/logout - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
    ...
    console.error(`[API] PATCH /api/auth/logout error:`, error);
    return NextResponse.json(
      { error: 'Internal Server Error', code: 'INTERNAL_ERROR', message: 'An unexpected error occurred' },
      {
        status: 500,
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    // Log request
    console.log(`[API] DELETE /api/auth/logout - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
    ...
    console.error(`[API] DELETE /api/auth/logout error:`, error);
    return NextResponse.json(
      { error: 'Internal Server Error', code: 'INTERNAL_ERROR', message: 'An unexpected error occurred' },
      {
        status: 500,
