...
/**
 * API Route Handler
 * Handles /api/clients operations
 *
 * GET /api/clients - Get resource
 * POST /api/clients - Create resource
 * PUT /api/clients - Update resource
 * PATCH /api/clients - Partial update resource
 * DELETE /api/clients - Delete resource
 *
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Log request
    console.log(`[API] GET /api/clients - ${request.headers.get('x-forwarded-for') || 'unknown'}`);

    const response = await proxyToBackend(request, "/api/clients");
...
// Validate required fields
    ...
    // Log request
    console.log(`[API] POST /api/clients - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
...
// Validate content type
    ...
    // Log request
    console.log(`[API] PUT /api/clients - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
...
// For PATCH, body can be partial, but should not be empty
    ...
    // Log request
    console.log(`[API] PATCH /api/clients - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    // Log request
    console.log(`[API] DELETE /api/clients - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
