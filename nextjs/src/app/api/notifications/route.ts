...
/**
 * API Route Handler
 * Handles /api/notifications operations
 *
 * GET /api/notifications - Get resource
 * POST /api/notifications - Create resource
 * PUT /api/notifications - Update resource
 * PATCH /api/notifications - Partial update resource
 * DELETE /api/notifications - Delete resource
 *
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Log request
    console.log(`[API] GET /api/notifications - ${request.headers.get('x-forwarded-for') || 'unknown'}`);

    const response = await proxyToBackend(request, "/api/notifications");
...
// Validate required fields
    ...
    // Log request
    console.log(`[API] POST /api/notifications - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
...
// Validate content type
    ...
    // Log request
    console.log(`[API] PUT /api/notifications - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
...
// For PATCH, body can be partial, but should not be empty
    ...
    // Log request
    console.log(`[API] PATCH /api/notifications - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    // Log request
    console.log(`[API] DELETE /api/notifications - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
