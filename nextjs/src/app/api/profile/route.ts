...
/**
 * API Route Handler
 * Handles /api/profile operations
 *
 * GET /api/profile - Get resource
 * POST /api/profile - Create resource
 * PUT /api/profile - Update resource
 * PATCH /api/profile - Partial update resource
 * DELETE /api/profile - Delete resource
 *
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Log request
    console.log(`[API] GET /api/profile - ${request.headers.get('x-forwarded-for') || 'unknown'}`);

    const response = await proxyToBackend(request, "/api/profile");
...
// Validate required fields
    ...
    // Log request
    console.log(`[API] POST /api/profile - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
...
// Validate content type
    ...
    // Log request
    console.log(`[API] PUT /api/profile - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
...
// For PATCH, body can be partial, but should not be empty
    ...
    // Log request
    console.log(`[API] PATCH /api/profile - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    // Log request
    console.log(`[API] DELETE /api/profile - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
