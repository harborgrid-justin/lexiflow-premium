...
/**
 * API Route Handler
 * Handles /api/projects operations
 *
 * GET /api/projects - Get resource
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Log request
    console.log(`[API] GET /api/projects - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
...
// Validate required fields
    ...
    // Log request
    console.log(`[API] POST /api/projects - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
