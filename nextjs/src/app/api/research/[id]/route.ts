...
/**
 * API Route Handler
 * Handles /api/research/[id] operations
 *
 * GET /api/research/[id]/[id] - Get specific resource
 * PUT /api/research/[id]/[id] - Update specific resource
 * PATCH /api/research/[id]/[id] - Partial update specific resource
 * DELETE /api/research/[id]/[id] - Delete specific resource
 *
...
// Validate and await params (Next.js v16 requirement)
    ...
    // Log request
    console.log(`[API] GET /api/research/[id]/${id} - ${request.headers.get('x-forwarded-for') || 'unknown'}`);

    const response = await proxyToBackend(request, "/api/research/${id}/${id}");
    ...
    console.error(`[API] GET /api/research/[id]/${id} error:`, error);
    return NextResponse.json(
...
// Validate content type
    ...
    // Log request
    console.log(`[API] PUT /api/research/[id]/${id} - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
    ...
    console.error(`[API] PUT /api/research/[id]/${id} error:`, error);
    return NextResponse.json(
      { error: 'Internal Server Error', code: 'INTERNAL_ERROR', message: 'An unexpected error occurred' },
      {
        status: 500,
...
// For PATCH, body can be partial, but should not be empty
    ...
    // Log request
    console.log(`[API] PATCH /api/research/[id]/${id} - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
    ...
    console.error(`[API] PATCH /api/research/[id]/${id} error:`, error);
    return NextResponse.json(
      { error: 'Internal Server Error', code: 'INTERNAL_ERROR', message: 'An unexpected error occurred' },
      {
        status: 500,
...
// Validate and await params (Next.js v16 requirement)
    ...
    // Log request
    console.log(`[API] DELETE /api/research/[id]/${id} - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
    ...
    console.error(`[API] DELETE /api/research/[id]/${id} error:`, error);
    return NextResponse.json(
      { error: 'Internal Server Error', code: 'INTERNAL_ERROR', message: 'An unexpected error occurred' },
      {
        status: 500,
