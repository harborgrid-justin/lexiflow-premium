...
/**
 * API Route Handler
 * Handles /api/risks/[id] operations
 *
 * GET /api/risks/[id]/[id] - Get specific resource
 * PUT /api/risks/[id]/[id] - Update specific resource
 * DELETE /api/risks/[id]/[id] - Delete specific resource
 *
...
// Validate and await params (Next.js v16 requirement)
    ...
    // Log request
    console.log(`[API] GET /api/risks/[id]/${id} - ${request.headers.get('x-forwarded-for') || 'unknown'}`);

    const response = await proxyToBackend(request, "/api/risks/${id}/${id}");
    ...
    console.error(`[API] GET /api/risks/[id]/${id} error:`, error);
    return NextResponse.json(
...
// Validate content type
    ...
    // Log request
    console.log(`[API] PUT /api/risks/[id]/${id} - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
    ...
    console.error(`[API] PUT /api/risks/[id]/${id} error:`, error);
    return NextResponse.json(
      { error: 'Internal Server Error', code: 'INTERNAL_ERROR', message: 'An unexpected error occurred' },
      {
        status: 500,
...
// Validate and await params (Next.js v16 requirement)
    ...
    // Log request
    console.log(`[API] DELETE /api/risks/[id]/${id} - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
    ...
    console.error(`[API] DELETE /api/risks/[id]/${id} error:`, error);
    return NextResponse.json(
      { error: 'Internal Server Error', code: 'INTERNAL_ERROR', message: 'An unexpected error occurred' },
      {
        status: 500,
