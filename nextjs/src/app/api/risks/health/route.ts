...
/**
 * API Route Handler
 * Handles /api/risks/health operations
 *
 * GET /api/risks/health - Get resource
 *
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Log request
    console.log(`[API] GET /api/risks/health - ${request.headers.get('x-forwarded-for') || 'unknown'}`);

    const response = await proxyToBackend(request, "/api/risks/health");
    ...
    console.error(`[API] GET /api/risks/health error:`, error);
    return NextResponse.json(
