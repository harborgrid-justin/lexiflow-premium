...
/**
 * API Route Handler
 * Handles /api/risks/heatmap operations
 *
 * GET /api/risks/heatmap - Get resource
 *
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Log request
    console.log(`[API] GET /api/risks/heatmap - ${request.headers.get('x-forwarded-for') || 'unknown'}`);

    const response = await proxyToBackend(request, "/api/risks/heatmap");
    ...
    console.error(`[API] GET /api/risks/heatmap error:`, error);
    return NextResponse.json(
