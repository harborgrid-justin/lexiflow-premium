...
/**
 * API Route Handler
 * Handles /api/settings operations
 *
 * GET /api/settings - Get resource
 * POST /api/settings - Create resource
 * PUT /api/settings - Update resource
 * PATCH /api/settings - Partial update resource
 * DELETE /api/settings - Delete resource
 *
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Log request
    console.log(`[API] GET /api/settings - ${request.headers.get('x-forwarded-for') || 'unknown'}`);

    const response = await proxyToBackend(request, "/api/settings");
...
// Validate required fields
    ...
    // Log request
    console.log(`[API] POST /api/settings - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
...
// Validate content type
    ...
    // Log request
    console.log(`[API] PUT /api/settings - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
...
// For PATCH, body can be partial, but should not be empty
    ...
    // Log request
    console.log(`[API] PATCH /api/settings - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    // Log request
    console.log(`[API] DELETE /api/settings - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
