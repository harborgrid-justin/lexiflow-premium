...
/**
 * API Route Handler
 * Handles /api/tasks/[id] operations
 *
 * GET /api/tasks/[id]/[id] - Get specific resource
 * PUT /api/tasks/[id]/[id] - Update specific resource
 * DELETE /api/tasks/[id]/[id] - Delete specific resource
 *
...
// Validate and await params (Next.js v16 requirement)
    ...
    console.error(`[API] GET /api/tasks/[id]/${id} error:`, error);
    return NextResponse.json(
...
// Validate content type
    ...
    console.error(`[API] PUT /api/tasks/[id]/${id} error:`, error);
    return NextResponse.json(
      { error: 'Internal Server Error', code: 'INTERNAL_ERROR', message: 'An unexpected error occurred' },
      {
        status: 500,
...
// Validate and await params (Next.js v16 requirement)
    ...
    console.error(`[API] DELETE /api/tasks/[id]/${id} error:`, error);
    return NextResponse.json(
      { error: 'Internal Server Error', code: 'INTERNAL_ERROR', message: 'An unexpected error occurred' },
      {
        status: 500,
