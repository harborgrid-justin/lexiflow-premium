...
/**
 * API Route Handler
 * Handles /api/tasks/bulk-update operations
 *
 * POST /api/tasks/bulk-update - Create resource
 *
...
// Validate required fields
    ...
    // Log request
    console.log(`[API] POST /api/tasks/bulk-update - ${request.headers.get('x-forwarded-for') || 'unknown'}`);

    const response = await proxyToBackend(request, "/api/tasks/bulk-update");
    ...
    console.error(`[API] POST /api/tasks/bulk-update error:`, error);
    return NextResponse.json(
