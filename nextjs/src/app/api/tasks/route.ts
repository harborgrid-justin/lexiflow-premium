...
/**
 * API Route Handler
 * Handles /api/tasks operations
 *
 * GET /api/tasks - Get resource
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Log request
    console.log(`[API] GET /api/tasks - ${request.headers.get('x-forwarded-for') || 'unknown'}`);

    const response = await proxyToBackend(request, "/api/tasks");
...
// Validate required fields
    ...
    // Log request
    console.log(`[API] POST /api/tasks - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
