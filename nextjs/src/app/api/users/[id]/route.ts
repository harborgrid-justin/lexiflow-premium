...
/**
 * API Route Handler
 * Handles /api/users/[id] operations
 *
 * GET /api/users/[id]/[id] - Get specific resource
 * PUT /api/users/[id]/[id] - Update specific resource
 * DELETE /api/users/[id]/[id] - Delete specific resource
 *
...
// Validate and await params (Next.js v16 requirement)
    ...
    // Log request
    console.log(`[API] GET /api/users/[id]/${id} - ${request.headers.get('x-forwarded-for') || 'unknown'}`);

    const response = await proxyToBackend(request, "/api/users/${id}/${id}");
    ...
    console.error(`[API] GET /api/users/[id]/${id} error:`, error);
    return NextResponse.json(
...
// Validate content type
    ...
    // Log request
    console.log(`[API] PUT /api/users/[id]/${id} - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
    ...
    console.error(`[API] PUT /api/users/[id]/${id} error:`, error);
    return NextResponse.json(
      { error: 'Internal Server Error', code: 'INTERNAL_ERROR', message: 'An unexpected error occurred' },
      {
        status: 500,
...
// Validate and await params (Next.js v16 requirement)
    ...
    // Log request
    console.log(`[API] DELETE /api/users/[id]/${id} - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
    ...
    console.error(`[API] DELETE /api/users/[id]/${id} error:`, error);
    return NextResponse.json(
      { error: 'Internal Server Error', code: 'INTERNAL_ERROR', message: 'An unexpected error occurred' },
      {
        status: 500,
