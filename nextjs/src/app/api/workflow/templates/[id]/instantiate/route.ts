...
/**
 * API Route Handler
 * Handles /api/workflow/templates/[id]/instantiate operations
 *
 * POST /api/workflow/templates/[id]/instantiate/[id] - Create specific resource
 *
...
// Validate required fields
    ...
    // Log request
    console.log(`[API] POST /api/workflow/templates/[id]/instantiate/${id} - ${request.headers.get('x-forwarded-for') || 'unknown'}`);

    const response = await proxyToBackend(request, "/api/workflow/templates/${id}/instantiate/${id}");
    ...
    console.error(`[API] POST /api/workflow/templates/[id]/instantiate/${id} error:`, error);
    return NextResponse.json(
