...
/**
 * API Route Handler
 * Handles /api/workflow/templates/[id] operations
 *
 * GET /api/workflow/templates/[id]/[id] - Get specific resource
 * PUT /api/workflow/templates/[id]/[id] - Update specific resource
 * DELETE /api/workflow/templates/[id]/[id] - Delete specific resource
 *
...
// Validate and await params (Next.js v16 requirement)
    ...
    // Log request
    console.log(`[API] GET /api/workflow/templates/[id]/${id} - ${request.headers.get('x-forwarded-for') || 'unknown'}`);

    const response = await proxyToBackend(request, "/api/workflow/templates/${id}/${id}");
    ...
    console.error(`[API] GET /api/workflow/templates/[id]/${id} error:`, error);
    return NextResponse.json(
...
// Validate content type
    ...
    // Log request
    console.log(`[API] PUT /api/workflow/templates/[id]/${id} - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
    ...
    console.error(`[API] PUT /api/workflow/templates/[id]/${id} error:`, error);
    return NextResponse.json(
      { error: 'Internal Server Error', code: 'INTERNAL_ERROR', message: 'An unexpected error occurred' },
      {
        status: 500,
...
// Validate and await params (Next.js v16 requirement)
    ...
    // Log request
    console.log(`[API] DELETE /api/workflow/templates/[id]/${id} - ${request.headers.get('x-forwarded-for') || 'unknown'}`);
    ...
    console.error(`[API] DELETE /api/workflow/templates/[id]/${id} error:`, error);
    return NextResponse.json(
      { error: 'Internal Server Error', code: 'INTERNAL_ERROR', message: 'An unexpected error occurred' },
      {
        status: 500,
