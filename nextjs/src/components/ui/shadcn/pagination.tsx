...
/**
 * Pagination - Enterprise table pagination with page numbers
 * Provides accessible navigation for paginated data
 *
 * Components:
...
const PaginationLink = ({
  ...
  <a
    ...
    className={cn(
      ...
      isActive && "border-slate-900 dark:border-slate-50",
      className
    )}
    {...props}
  />
