          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setNewSession({ ...newSession, method: e.target.value as string })}
              >
                <option>Phone</option>
                <option>Email</option>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setNewSession({ ...newSession, result: e.target.value as string })}
              >
