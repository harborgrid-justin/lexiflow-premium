...
export const DocketEntryBuilder: React.FC<DocketEntryBuilderProps> = ({
  ...
  useEffect(() => {
    ...
    // Compute preview text with useMemo instead of useEffect
    ...
    const handleSave = async () => {
      ...
      if (autoGenerateDeadlines && entry.caseId) {
        type HasJurisdiction = { jurisdiction?: string | unknown };
        const jurisdiction = (caseData && typeof caseData === 'object' && 'jurisdiction' in caseData && (caseData as HasJurisdiction).jurisdiction) ? String((caseData as HasJurisdiction).jurisdiction) : 'Federal';
