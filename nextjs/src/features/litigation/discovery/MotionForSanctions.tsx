            ...
            <Modal isOpen={sanctionModal.isOpen} onClose={sanctionModal.close} title="Draft Sanctions Motion">
                <div className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <select className={cn("w-full p-2 border rounded text-sm", theme.surface.default, theme.border.default, theme.text.primary)} value={newMotion.ruleBasis} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setNewMotion({ ...newMotion, ruleBasis: e.target.value })}>
