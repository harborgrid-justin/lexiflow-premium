...
export const MessengerChatWindow = ({
  ...
  // Simulate incoming messages/typing with proper cleanup (Rule #6, #7)
  useInterval(() => {
  ...
  // Auto-clear typing indicator after delay (Rule #6 - proper cleanup)
  useEffect(() => {
    if (!isTyping) return;
    ...
    // Strict Mode ready: Cleanup prevents stale timers (Rule #7)
