                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select className="w-full p-2 border rounded text-sm" value={newPerm.action} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setNewPerm({ ...newPerm, action: e.target.value })}>
                        ...
                        <div>
                            ...
                            <select className="w-full p-2 border rounded text-sm" value={newPerm.effect} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setNewPerm({ ...newPerm, effect: e.target.value })}>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select className="w-full p-2 border rounded text-sm" value={newPerm.scope} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setNewPerm({ ...newPerm, scope: e.target.value })}>
