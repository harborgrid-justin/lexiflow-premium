 ...
 */
export type ComponentImportFunc<T = unknown> = () => Promise<{
 ...
 */
export interface LazyComponentState<T = unknown> {
 ...
 */
export interface PreloadableComponent<T = unknown> {
  /** Lazy component */
 ...
 * ```
 */
export function useLazyComponentWithState<T = unknown>(
  importFunc: ComponentImportFunc<T>,
  options: {
    /** Auto-load on mount */
    autoLoad?: boolean;
 ...
 * ```
 */
export function usePreloadableComponent<T = unknown>(
  importFunc: ComponentImportFunc<T>
 ...
 * ```
 */
export function useIdleLazyComponent<T = unknown>(
  importFunc: ComponentImportFunc<T>
): LazyExoticComponent<ComponentType<T>> {
