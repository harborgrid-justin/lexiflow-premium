...
export const API_ENDPOINTS = {
  ...
  INTERROGATORIES: {
    LIST: "/discovery-requests?type=Interrogatory",
    DETAIL: (id: string) => `/discovery-requests/${id}`,
    CREATE: "/discovery-requests",
    UPDATE: (id: string) => `/discovery-requests/${id}`,
    DELETE: (id: string) => `/discovery-requests/${id}`,
  ...
  ADMISSIONS: {
    LIST: "/discovery-requests?type=Admission",
    DETAIL: (id: string) => `/discovery-requests/${id}`,
    CREATE: "/discovery-requests",
    UPDATE: (id: string) => `/discovery-requests/${id}`,
    DELETE: (id: string) => `/discovery-requests/${id}`,
  ...
  PRODUCTION_REQUESTS: {
    LIST: "/discovery-requests?type=Production",
    DETAIL: (id: string) => `/discovery-requests/${id}`,
    CREATE: "/discovery-requests",
    UPDATE: (id: string) => `/discovery-requests/${id}`,
    DELETE: (id: string) => `/discovery-requests/${id}`,
  ...
  BILLING: {
    ROOT: "/billing",
    METRICS: "/analytics/billing/metrics",
    ANALYTICS: "/analytics/billing",
    PROFITABILITY: "/analytics/billing/profitability",
    REALIZATION: "/analytics/billing/realization",
    WIP: "/analytics/billing/wip",
    FORECAST: "/analytics/billing/forecast",
    TIMEKEEPER_PERFORMANCE: "/analytics/billing/timekeeper-performance",
